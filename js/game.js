...
function iHeartYou(){
	...
	if(window.location.hash){
		...
		vtext.textContent = "很美好的一句话...（你可以自定义";
	}
...
function linkChangey(){
	if(yourMessage.value==""){
		yourLink.value = "http://door.66619.eu.org";
	}else{
		yourLink.value = "http://door.66619.eu.org/#"+encodeURIComponent(encryptString(yourMessage.value));
	}
};
